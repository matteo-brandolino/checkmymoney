...
export default function CommonCard({
  ...
  return (
    <View className="w-11/12 mx-auto h-full relative">
      <Card className="rounded-3xl h-5/6 relative">
        <CardHeader>
        ...
        <CardFooter className="flex flex-row justify-center">
          <Button
            className="rounded-full absolute bottom-0 flex flex-row justify-between"
            onPress={saveKeys}
          >
