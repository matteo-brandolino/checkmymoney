...
const originalColorsPath = path.join(process.cwd(), "global.css");
const originalColors = getColorsFromCSS(originalColorsPath);

// Read new colors from newColors.css
const newColorsPath = path.join(process.cwd(), "newColors.css");
...
const updatedColorsPath = path.join(process.cwd(), "updatedColors.css");
