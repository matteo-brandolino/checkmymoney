...
export default function NewTemplate() {
  ...
  return (
    <View className="w-4/5 mx-auto flex-1">
      ...
      <Button className="w-3/4 mx-auto sticky bottom-8">
        <P className="color-background flex-row items-baseline">
          Create a template <Check className="text-background" size={24} />
        </P>
      </Button>
    </View>
  );
