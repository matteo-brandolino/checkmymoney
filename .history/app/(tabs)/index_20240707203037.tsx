    ...
    <View className="flex-row flex-wrap justify-around">
      {data &&
        ...
        data.map((d) => (
          ...
          >
            <Card className="border border-border" key={d.key}>
              <CardHeader>
                <CardTitle className="color-secondary">{d.title}</CardTitle>
                <CardDescription className="color-secondary">
                  {d.description}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <P className="color-secondary">{d.sum}</P>
              </CardContent>
            </Card>
          </View>
        ))}
