      ...
      {data && (
        <View className="basis-[95%]">
          <Card className="border bg-secondary">
            <CardContent className="flex-row justify-between border">
              <View className="border-r-2 h-full justify-center flex-auto">
              ...
              <View className="justify-center flex-auto">
                <View className="my-4">
                  ...
                  <P className="color-background">{data.income.description}</P>
                  <P className="color-background">{data.income.sum} €</P>
                </View>
                <View>
                  <H3 className="color-background">{data.expense.title}</H3>
                  <P className="color-background">{data.expense.description}</P>
