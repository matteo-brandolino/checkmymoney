...
>((props, forwardedRef) => {
  ...
  if (!React.isValidElement(children)) {
    console.info("Slot.Pressable - Invalid asChild element", children);
    return null;
  }
...
const View = React.forwardRef<React.ElementRef<typeof RNView>, RNViewProps>(
  (props, forwardedRef) => {
    ...
    if (!React.isValidElement(children)) {
      console.info("Slot.View - Invalid asChild element", children);
      return null;
    }
...
const Text = React.forwardRef<React.ElementRef<typeof RNText>, RNTextProps>(
  (props, forwardedRef) => {
    ...
    if (!React.isValidElement(children)) {
      console.info("Slot.Text - Invalid asChild element", children);
      return null;
    }
...
>((props, forwardedRef) => {
  ...
  if (!React.isValidElement(children)) {
    console.info("Slot.Image - Invalid asChild element", children);
    return null;
  }
